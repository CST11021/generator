...
public class Context extends PropertyHolder {
    ...
    /**
     * 连接DB，获取表和字段信息，并初始化 IntrospectedTable 实例
     *
     * @param callback
    ...
    public void setJavaQueryModelGeneratorConfiguration(JavaQueryModelGeneratorConfiguration javaQueryModelGeneratorConfiguration) {
        this.javaQueryModelGeneratorConfiguration = javaQueryModelGeneratorConfiguration;
    }
